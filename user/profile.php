                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <img src="<?= $_SESSION['user']['avatar'] ?>" alt="Admin" width="200">
                                <div class="mt-3">
                                <h4><?= $_SESSION['user']['login'] ?></h4>
                                    <p class="text-secondary mb-1"><?= $_SESSION['user']['prof'] ?></p>
                                    <p class="text-muted font-size-sm"><?= $_SESSION['user']['adress'] ?></p>
                                    <button class="btn btn-primary">Настройки</button>
                                    <a class="link-success" href="/NotLaravelProject/catalog/dwload.php">Загрузить файл</a>
                                    <a class="link-danger" href="vendor/logout.php">Выйти из профиля</a>
                                </div>
                            </div>
                        </div>
                    </div>
