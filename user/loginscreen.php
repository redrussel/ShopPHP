      ...
      <div>
          <section class="d-flex justify-content-center align-items-center-center">
              ...
              <form action="vendor/signin.php" method="post">
                  ...
                  <label for="inputPassword" class="col-sm-2 col-form-label">Почта</label>
                  <input type="text" name="login" class="form-control" id="inputPassword" placeholder="Введите логин">
